...
if 'generated' not in st.session_state:
    st.session_state['generated'] = ["Hello! Ask me anything about Chris"]
...
with container:
    with st.form(key='my_form', clear_on_submit=True):
        user_input = st.text_input("Question:", placeholder="Ask your questions here", key='input')
